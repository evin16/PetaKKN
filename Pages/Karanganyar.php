...
<body>
    <nav class="navbar navbar-light bg-light">
        <div class=" container row">
            <div class="col d-flex">
                <a href="../index.php"><img src="../assets/logo.png" alt="logo" width="64px"></a>
                <h3 class="m-3">Pemetaan Kelompok KKN Kabupaten Karanganyar</h3>
            </div>
        </div>
    </nav>
    ...
    <script type="text/javascript" src="../Peta/Karanganyar.js"></script>

    <script type="text/javascript">
        var map = L.map('map').setView([-7.60, 110.98], 12);
